...
public class RunTamaSavPtModeChoice {
	...
	final public static String INPUT_SAV_VEHICLES_FOLDER = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\vehicles\\";
	final public static String INPUT_SAV_STOPS = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\drtstops.xml";

	final public static String INPUT_SAMPLE_POPULATION_FOLDER = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\sample population\\";
	final public static String INPUT_POPULATION = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_plans.xml.gz";
//	final public static String INPUT_SUB_POPULATION = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\personAtrributes-with-subpopulation.xml";

	final public static String INPUT_ROAD_PRICING = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_toll.xml.gz";
	final public static String INPUT_COUNTS = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_counts.xml.gz";
	final public static String INPUT_NETWORK = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_network.xml.gz";	
	final public static String INPUT_FACILITES = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_facilities.xml.gz";
	final public static String INPUT_TRANSIT_SCHEDULE = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_transitSchedule.xml.gz";
	final public static String INPUT_TRANSIT_VEHICLES = "E:\\geosimlab\\MATSim-TAMA\\MATSim-TAMA DRT Input\\2.output_transitVehicles.xml.gz";
